        ...
        <div className='relative'>
            ...
            <div className="grid gap-2 grid-cols-[2fr_1fr]">
                <div>
                    {place.photos?.[0] && (
                        <div>
                            <img onClick={() => setShowAllPhotos(true)} className='cursor-pointer aspect-square object-cover rounded-tl-2xl rounded-bl-2xl' src={'http://localhost:4000/uploads/' + place.photos?.[0]} />
                ...
                <div className='grid'>
                    {place.photos?.[1] && (
                        <img onClick={() => setShowAllPhotos(true)} className='cursor-pointer aspect-square object-cover rounded-tr-2xl ' src={'http://localhost:4000/uploads/' + place.photos?.[1]} />
                    )}
